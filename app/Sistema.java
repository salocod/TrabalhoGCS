...
class Sistema {
    ...
    private void metodo3() {
        //metodo adicionar registro de custo
        System.out.println("Adiciona Custo ");
        System.out.println("Digite o valor:");
        double valor = sc.nextDouble();
        sc.nextLine();
        System.out.println("Faça a descrição: ");
        ...
        String departmaneto = sc.nextLine();
        Departamento departamento = pesquisarDepartamento(departmaneto);
        Custo custo = new Custo(valor, descricao, d, categoria, departamento);


        adicionarCusto(funcionarioLogado(), custo);
    }
        ...
        do {
            ...
            switch (sc.nextInt()) {
                ...
                case 3:
                    ...
                    custos = pesquisaCustoDepartamento(sc.nextLine());
                    System.out.println(custos);
                    break;
                    ...
                    do{
                        ...
                        switch (sc.nextInt()) {
                            ...
                            case 1:
                                ...
                                dia = sc.nextInt();
                                System.out.println("Digite o mês em dois digitos:");
                                mes = sc.nextInt();
                                System.out.println("Digite o ano em quatro digitos:");
                                ano = sc.nextInt();
                                data = new Date(ano, mes, dia);
                                custos = pesquisaCustoDataDia(data);
                                System.out.println(custos);
                                break;
                            case 2:
                                System.out.println("Digite o mês em dois digitos:");
                                ...
                                custos = pesquisaCustoDataMes(data);
                                System.out.println(custos);
                                break;
                            case 3:
                                System.out.println("Digite o ano em quatro digitos");
                                ano = sc.nextInt();
                                data = new Date(ano, 01,01);
                                custos = pesquisaCustoDataAno(data);
                                System.out.println(custos);
                                break;
                            default:
    ...
    private ArrayList<Custo> pesquisaCustoDataDia(Date data) {
        ArrayList<Custo> custos = new ArrayList<>();
        for(Custo custo : empresa.getCustosTotais()){
    ...
    private ArrayList<Custo> pesquisaCustoDataMes(Date data) {
        ArrayList<Custo> custos = new ArrayList<>();
        for(Custo custo : empresa.getCustosTotais()){
            if(custo.getData().getMonth() == data.getMonth() &&
                    custo.getData().getYear() == data.getYear())
                custos.add(custo);
        }
        custos.sort(Comparator.comparing(Custo::getData));
        return custos;
    ...
    private ArrayList<Custo> pesquisaCustoDataAno(Date data) {
        ArrayList<Custo> custos = new ArrayList<>();
        for(Custo custo : empresa.getCustosTotais()){
            if(custo.getData().getYear() == data.getYear())
                custos.add(custo);
        }
        custos.sort(Comparator.comparing(Custo::getData));
        return custos;
